...
To keep verbal as lightweight as possible, some of its functionality requires the use of external modules.
...
First, the post-compression size of the above modules is orders of magnitude bigger than verbal. This
...
seemed promising, but unfortunatelly we hit a roadblock that had no simple way of overcoming; verbal itself is an injectable component that
...
Therefore, to make the lives of our developers as simple as possible; for use cases that do not need the extra functionality - verbal can
