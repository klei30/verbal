...
Method properties that can be called directly on the verbal element.

:::info
Make sure the verbal component has been fully rendered on the DOM before using these.
:::
