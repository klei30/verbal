...
Insert your markup between the verbal element tags and the component will render it inside the intro panel.
...
Because verbal is a [shadow element](https://developer.mozilla.org/en-US/docs/Web/API/Web_components/Using_shadow_DOM) - the intro panel will not have access
