...
Because verbal is a [shadow element](https://developer.mozilla.org/en-US/docs/Web/API/Web_components/Using_shadow_DOM) and your html is rendered inside it - the resulting elements will not be able to access the CSS and JavaScript
...
### verbal Classes {#deepChatClasses}

verbal comes with a pre-defined set of classes that can be used to add styling/functionality to your elements. <br />
...
Basic suggestion buttons using [verbal Classes](#deepChatClasses).
