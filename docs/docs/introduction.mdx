...
<h2 id="#heading-id">verbal is a framework agnostic chat component built to bring AI services to life</h2>
...
This is why verbal is built to be fully customizable; from interactive features to minute styling details - everything can be changed to build
the component you need.

Developer experience is paramount to this component's success! This is why verbal is shipped in a cross-framework plug-and-play package to allow you
...
Open source is at the heart of what we do. verbal is built by the community - for the community. All contributions to this [**project**](https://github.com/OvidijusParsiunas/deep-chat) are welcome!
